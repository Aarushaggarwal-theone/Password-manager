def add_pwd(url, pwd, url_s, pwd_s):
    ...
    Args:
        url (str): insert the url of website to which the pwd being added
        belongs to.
        pwd (str): insert the pwd which is to be saved for given url.

    Returns:
        Adds a dict to the database named dictionary and adds url and pwd to
        the url_s and pwd_s lists respectively]65
    """
